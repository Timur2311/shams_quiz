...
def random_opponent(update: Update, context: CallbackContext):
    ...
    created_user_challenge = UserChallenge.objects.prefetch_related('questions',"challenge_answers").prefetch_related(
        'users').select_related('user').select_related('opponent').select_related('challenge').get(id=user_challenge_id)

    user_random_challenges = UserChallenge.objects.prefetch_related('questions',"challenge_answers").prefetch_related('users').select_related('user').select_related(
    ...
    possible_challenges = UserChallenge.objects.prefetch_related('questions',"challenge_answers").prefetch_related('users').select_related('user').select_related('opponent').select_related('challenge').filter(
...
def challenge_callback(update: Update, context: CallbackContext):
    ...
    user_challenge = UserChallenge.objects.prefetch_related('questions','users',"challenge_answers").select_related(
